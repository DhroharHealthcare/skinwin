...
const LLLT = () => {
  const faqs = [
    {
      question: "What does LLLT do for hair loss?",
      answer: "LLLT improves blood circulation in the scalp and stimulates hair follicles, helping strengthen hair and support regrowth."
    },
    {
      question: "How many LLLT sessions are needed?",
      answer: "Multiple sessions over several weeks are recommended for best results."
    },
    {
      question: "Is LLLT painful or uncomfortable?",
      answer: "No. LLLT is a painless and non-invasive procedure."
    },
    {
      question: "Can LLLT be combined with other hair treatments?",
      answer: "Yes. LLLT works best when combined with PRP, GFC, mesotherapy, or medical treatment."
    },
    {
      question: "Is there any downtime after LLLT?",
      answer: "No downtime. Normal activities can be resumed immediately."
    }
  ];
      ...
      <div className="relative bg-[#FBF5E9] py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Painless, non-invasive laser therapy to stimulate hair growth.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">What is LLLT?</h2>
          </div>

          <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100">
            <p className="text-gray-600 leading-relaxed text-lg">
              <strong>LLLT (Low-Level Laser Therapy)</strong> uses controlled laser light to stimulate blood circulation in the scalp and activate hair follicles. It improves hair strength and supports natural regrowth without surgery or injections.
            </p>
          </div>
        </section>
          ...
          <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
            ...
            <ul className="space-y-4">
              {[
                ...
                "Thinning hair",
                "Men and women seeking non-invasive treatment",
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-center">
                    <span className="h-2 w-2 bg-gray-400 rounded-full mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
                ))}
              </ul>
        ...
        <section className="bg-gray-50 rounded-3xl p-8 md:p-12 text-center border border-gray-100">
          ...
          <div className="bg-white rounded-2xl border-2 border-dashed border-gray-300 p-12 text-gray-500 mb-8 max-w-4xl mx-auto">
            <span className="block text-lg font-medium">[ LLLT Before & After Gallery ]</span>
          </div>
        </section>
