...
const TreatmentCategory = ({ title, treatments }: { title: string; treatments: Treatment[] }) => (
  <div className="mb-12">
  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        {treatmentCategories.map((category: { title: string; treatments: Treatment[] }, index: number) => (
