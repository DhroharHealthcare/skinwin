      ...
      <div className="relative bg-[#FBF5E9] py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Restore volume, enhance facial contours, and achieve youthful balance with advanced dermal fillers.
          </p>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-4">What are Dermal Fillers?</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Dermal fillers are injectable treatments used to restore lost volume, smooth deep wrinkles,
                and enhance facial features. They work by adding structure and hydration to targeted areas,
                helping create a youthful and well-balanced appearance.
              </p>
              <p className="text-gray-600 leading-relaxed font-medium">
                At Skin Win Clinic, fillers are used conservatively to ensure <strong>natural, harmonious results</strong>.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Precise and controlled injection",
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-4">
                {[
                  "Volume loss in cheeks and face",
