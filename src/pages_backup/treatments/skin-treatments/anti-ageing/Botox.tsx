      ...
      <div className="relative bg-[#FBF5E9] py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Smooth fine lines and wrinkles with safe, doctor-supervised Botox treatment.
          </p>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-4">What is Botox?</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Botox is a non-surgical cosmetic treatment that works by relaxing targeted facial muscles
                responsible for expression lines. It helps soften wrinkles and prevents new lines from forming,
                while maintaining natural facial expressions.
              </p>
              <p className="text-gray-600 leading-relaxed font-medium">
                At Skin Win Clinic, Botox treatment is performed with precision and care to achieve subtle,
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Identification of targeted muscles",
                  "Controlled administration of Botox",
            ...
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Individuals seeking non-surgical anti-ageing solutions"
                ].map((item: any, index: number) => (
                  <li key={index} className="flex items-start">
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Certain neuromuscular conditions (evaluated during consultation)"
                ].map((item: any, index: number) => (
                  <li key={index} className="flex items-start">
          ...
          <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#FBF5E9]">
            <ul className="grid md:grid-cols-3 gap-6">
              {[
                ...
                "Prevents worsening of expression lines",
