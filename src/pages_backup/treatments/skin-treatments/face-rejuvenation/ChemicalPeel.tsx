      ...
      <div className="relative bg-[#FBF5E9] py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Advanced exfoliation treatment for clearer, brighter, and smoother skin.
          </p>
        </div>
      </div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-4">What is a Chemical Peel?</h3>
              <p className="text-gray-600 leading-relaxed">
                A chemical peel uses medical-grade solutions to exfoliate the top layers of skin,
                remove dead cells, and stimulate new skin regeneration. It helps improve pigmentation,
                acne marks, dull skin, and uneven texture.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4">
                {[
                  "Skin assessment and peel selection",
                  "Application of controlled chemical solution",
                  "Neutralization and soothing care",
                  "Post-procedure skin protection guidance"
            ...
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Reduced pigmentation and marks",
                  "Improved skin texture",
                  "Stimulates new skin renewal"
                ].map((item: any, index: number) => (
                  <li key={index} className="flex items-start">
