...
interface CareCardProps {
  title: string;
  content: AfterCareSection[];
}

// Enhanced CareCard component (keeping your existing styling)
const CareCard = ({ title, content }: CareCardProps) => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
            ...
            <Link href="/contact" className="bg-[#C09A50] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#A0824A] transition-colors inline-block">
              Contact Clinic
            </Link>
          </div>
        </div>
