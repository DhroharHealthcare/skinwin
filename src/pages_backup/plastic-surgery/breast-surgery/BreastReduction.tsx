      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {symptoms.map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "General" }, { label: "Initial Recovery", value: "2–3 weeks" }].map((stat: any, i: number) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Maintain stable body weight before surgery", "Avoid smoking before and after surgery", "Discuss future pregnancy plans with your surgeon", "Breastfeeding ability may be affected — discuss during consultation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Significant relief from neck, shoulder, and back pain", "Improved posture and mobility", "Better body proportion and balance", "Relief from skin irritation under breasts", "Improved ability to exercise and be active", "Enhanced confidence and quality of life"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling or bruising", "Recovery period of 2–3 weeks required", "Scarring (fades significantly over time)", "May affect breastfeeding ability", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Maintain stable body weight", "Avoid smoking before and after surgery", "Discuss future pregnancy plans with your surgeon", "Follow all pre-surgery instructions carefully"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Wear compression or support garments as advised", "Avoid heavy lifting and strenuous activity", "Follow wound care and medication instructions carefully", "Sleep with upper body slightly elevated", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
