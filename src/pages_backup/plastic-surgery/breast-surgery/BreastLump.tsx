      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {["A new lump in the breast or underarm", "Change in size, shape, or feel of the breast", "A painful or painless lump", "Nipple discharge or inversion", "Redness, warmth, or skin changes on the breast", "A lump that does not go away after your menstrual cycle"].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <ul className="space-y-4">
              {["Detailed clinical examination and history taking", "Medical history and risk factor assessment", "Imaging studies — ultrasound or mammography if required", "Additional tests or biopsy if clinically advised"].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[{ benefit: "Early Diagnosis", desc: "Catch any condition at its most treatable stage" }, { benefit: "Peace of Mind", desc: "Clarity and reassurance for you and your family" }, { benefit: "Better Outcomes", desc: "Early treatment leads to better health and cosmetic results" }, { benefit: "Timely Care", desc: "Prevent complications by not delaying evaluation" }].map((item: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Note changes in size, pain, or duration of the lump", "Avoid self-diagnosis or self-treatment", "Do not press or massage the lump repeatedly", "Bring any previous reports or investigations if available"].map((item: any, i: number) => (
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Follow the doctor's advice carefully", "Attend all follow-up visits as advised", "Take prescribed medications as directed", "Report any new changes in the lump or breast immediately"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
