        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            <ul className="space-y-4 mb-6">
              {["Detailed facial assessment and contour analysis", "Selection of suitable implant size and shape", "Anaesthesia administered", "Small incision placed inside the mouth or lower eyelid", "Implants precisely placed and positioned over cheekbones", "Incisions carefully closed to minimise visible scarring"].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Flat or under-developed cheeks", "Age-related facial volume loss", "Facial asymmetry", "Individuals seeking permanent cheek enhancement", "Those wanting sharper cheekbone definition"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Active facial infections", "Certain medical conditions (evaluated during consultation)", "Unrealistic expectations"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Enhanced cheekbone definition", "Improved facial balance and symmetry", "Youthful, contoured facial appearance", "Permanent, natural-looking results", "Boosted confidence and self-image"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol before surgery", "Inform the doctor about medications or medical conditions", "Avoid blood-thinning medicines if advised", "Follow all pre-surgery instructions during consultation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid touching or applying pressure on cheeks", "Follow oral hygiene or wound care instructions carefully", "Avoid strenuous activity initially", "Take prescribed medications as advised", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
