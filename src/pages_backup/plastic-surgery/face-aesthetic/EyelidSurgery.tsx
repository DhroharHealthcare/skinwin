        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Droopy or sagging upper eyelids", "Under-eye bags or puffiness", "Age-related eyelid skin excess", "Vision obstruction from hooded upper lids", "Tired, aged appearance around the eyes"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Good overall eye and general health required", "Avoid blood-thinning medications before surgery", "Realistic expectations about outcomes", "May be combined with brow lift for better results"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Brighter, more youthful eye appearance", "Improved field of vision (upper lid)", "Long-lasting results (10–15 years)", "Minimal visible scarring", "Natural-looking, refreshed eyes"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Mild dryness or eye irritation initially", "Healing time required", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol before surgery", "Inform about all medications and eye conditions", "Avoid blood-thinning medicines as advised", "Arrange for someone to drive you home after surgery"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid rubbing or touching the eyes", "Keep the area clean and dry", "Apply cold compress to reduce swelling", "Avoid strenuous activity for a few days", "Follow all medication and eye care instructions"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
