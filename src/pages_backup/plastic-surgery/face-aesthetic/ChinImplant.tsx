            ...
            {[
              ...
              <div key={i} className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
                ...
                <ul className="space-y-3">
                  {item.points.map((p: any, j: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            <ul className="space-y-4 mb-6">
              {["Detailed facial assessment and profile analysis", "Selection of appropriate implant size and shape", "Anaesthesia administered", "Small incision made inside the mouth or under the chin", "Implant precisely positioned over the chin bone", "Incision carefully closed to minimise visible scarring"].map((item: any, i: number) => (
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "Local / General" }, { label: "Initial Recovery", value: "1–2 weeks" }].map((stat: any, i: number) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Weak or recessed chin", "Poor facial profile balance", "Desire for a sharper, more defined lower face", "Facial imbalance (especially from side profile)", "Individuals with realistic expectations"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Active infections in the facial area", "Certain medical conditions (assessed during consultation)", "Unrealistic expectations"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Improved chin projection and shape", "Better facial balance and profile", "Enhanced jawline definition", "Permanent and natural-looking results", "Boosted confidence and self-image"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling or bruising", "Mild discomfort during healing", "Rare implant-related complications", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol before surgery", "Inform the doctor about medical conditions or medications", "Avoid blood-thinning medicines if advised", "Follow all pre-surgery instructions during consultation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid touching or putting pressure on the chin area", "Follow oral hygiene or wound care instructions carefully", "Avoid strenuous activity for a few days", "Take prescribed medications as advised", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
