      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[{ icon: "⏱", label: "Procedure Time", value: "30–45 mins" }, { icon: "💉", label: "Anaesthesia", value: "Numbing cream" }, { icon: "🏥", label: "Downtime", value: "Minimal / None" }, { icon: "✨", label: "Results Last", value: "6–12 months" }].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            <ul className="space-y-4">
              {["Detailed consultation and lip analysis", "Selection of appropriate filler type and quantity", "Application of numbing cream for comfort", "Precise filler placement to enhance volume and shape", "Gentle massage for even distribution", "Immediate visible improvement with natural finish"].map((item: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Thin or flat lips wanting more volume", "Loss of lip volume due to ageing", "Uneven or asymmetrical lips", "Poorly defined lip borders", "Anyone seeking natural lip enhancement"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Active lip infections or cold sores", "Certain medical conditions (evaluated during consultation)", "Pregnancy or breastfeeding"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Fuller, well-defined, beautiful lips", "Improved lip symmetry and contour", "Natural-looking, subtle results", "Non-surgical with minimal downtime", "Reversible — fillers can be dissolved if needed"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling or bruising", "Mild tenderness for 1–2 days", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid alcohol before the procedure", "Inform the doctor about medications and medical conditions", "Avoid blood-thinning medicines if advised", "Keep lips free from active infections or sores"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid touching or massaging the lips", "Avoid hot beverages and strenuous activity for 24 hours", "Mild swelling or bruising is normal and temporary", "Avoid heavy makeup on lips for 24 hours", "Follow all aftercare instructions from your doctor"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
