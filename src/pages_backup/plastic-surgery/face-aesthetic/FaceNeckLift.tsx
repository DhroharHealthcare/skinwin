        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            <ul className="space-y-4 mb-6">
              {["Pre-surgical consultation, photographs & treatment planning", "General anaesthesia or sedation administered", "Incisions made along hairline, temples, and behind the ears", "Underlying facial muscles and tissues lifted and tightened", "Excess skin carefully removed and remaining skin re-draped", "Neck muscles tightened and neck skin addressed separately", "Incisions closed meticulously to minimise scarring"].map((item: any, i: number) => (
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "General / Sedation" }, { label: "Initial Recovery", value: "2–3 weeks" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Sagging facial skin and jowls", "Loose or sagging neck skin", "Deep wrinkles and facial folds", "Loss of jawline and neck definition", "Adults in good overall health with realistic expectations"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Eyelid surgery (Blepharoplasty)", "Brow lift for upper face rejuvenation", "Fat grafting for volume restoration", "Laser resurfacing for skin texture"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Comprehensive facial & neck rejuvenation", "Improved jawline and neck contour", "Long-lasting results (7–10 years)", "Natural-looking, balanced outcome", "Significant improvement in self-confidence"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Recovery period of 2–3 weeks", "Scarring (minimal, hidden in hairline)", "Mild discomfort during healing"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol", "Inform about all medications and medical conditions", "Avoid blood-thinning medicines as advised", "Arrange for post-surgery support at home"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid sun exposure during healing", "Follow skincare and wound care instructions", "Avoid strenuous activities and heavy lifting", "Sleep with head elevated to reduce swelling", "Attend all follow-up visits as scheduled"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
