          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Loose or sagging abdominal skin after pregnancy", "Post weight-loss skin laxity", "Abdominal muscle separation (diastasis recti)", "Stubborn abdominal fat with skin excess", "Individuals at stable body weight with good health"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Planning future pregnancies", "Significant obesity — weight loss recommended first", "Active infections or uncontrolled medical conditions", "Smokers who cannot quit before surgery"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Flat, firm, and contoured abdomen", "Tightened and strengthened core muscles", "Improved posture and core stability", "Removal of lower abdominal stretch marks", "Boosted confidence and body image"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Recovery period of 2–3 weeks", "Scarring (well-placed and fades over time)", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Maintain stable weight before surgery", "Avoid smoking — smoking impairs healing significantly", "Discuss future pregnancy plans with your surgeon", "Follow all pre-surgery preparation instructions"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid heavy lifting for 6 weeks as advised", "Wear compression garments as prescribed", "Follow wound care and drain instructions if applicable", "Sleep with knees bent/elevated to reduce tension", "Attend all scheduled follow-up visits"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
