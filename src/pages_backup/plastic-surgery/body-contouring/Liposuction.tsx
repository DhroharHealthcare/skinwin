        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "General / Local + Sedation" }, { label: "Initial Recovery", value: "1–2 weeks" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Localized fat deposits that don't respond to diet/exercise", "Good skin elasticity", "Individuals close to their ideal body weight", "Stable body weight for at least 6 months", "Good overall health with realistic expectations"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Significant obesity or large-volume fat removal goals", "Poor skin elasticity (may need skin removal procedure)", "Active infections or uncontrolled medical conditions", "Unrealistic expectations of dramatic weight loss"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Improved body contour and proportion", "Targeted removal of stubborn fat", "Long-lasting results with healthy lifestyle", "Can treat multiple areas in one session", "Boost in confidence and self-image"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Mild discomfort during recovery", "Uneven contour if skin elasticity is poor", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Maintain stable body weight", "Avoid smoking and alcohol", "Inform the doctor about all medications", "Follow all pre-surgery instructions carefully"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Wear compression garments as advised", "Avoid heavy physical activity initially", "Follow wound care instructions carefully", "Maintain a healthy diet and lifestyle", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
