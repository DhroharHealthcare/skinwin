      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {procedures.map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical (Combined)" }, { label: "Anaesthesia", value: "General" }, { label: "Recovery", value: "Longer — varies by combination" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Women with post-pregnancy body changes", "Loose abdominal skin or separated muscles", "Breast sagging, volume loss, or asymmetry", "Stubborn fat deposits that don't respond to diet/exercise", "Women who have completed their family and are at stable weight"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Planning future pregnancies", "Breastfeeding currently", "Significant weight fluctuation ongoing", "Uncontrolled medical conditions", "Unrealistic expectations"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Comprehensive full-body restoration in one session", "Fewer total surgeries and anaesthetics", "Shorter total recovery time vs separate procedures", "Restored body contour, symmetry, and confidence", "Personalized to address your specific concerns"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Longer recovery than a single procedure", "Surgical risks vary per procedure combination", "Temporary swelling, bruising, and discomfort", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Maintain stable body weight before surgery", "Avoid smoking and alcohol", "Discuss all expectations clearly during consultation", "Arrange at-home support for post-surgery recovery"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Follow all wound care and compression garment instructions", "Avoid heavy lifting and strenuous activity", "Maintain proper nutrition and hydration for healing", "Attend all follow-up visits as scheduled"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
