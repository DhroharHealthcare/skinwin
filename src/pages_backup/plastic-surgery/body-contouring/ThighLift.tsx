          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Loose or sagging thigh skin", "Post weight-loss skin laxity", "Thighs with poor tone or contour", "Inner thigh chafing or discomfort", "Individuals with stable body weight and good health"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Uncontrolled medical conditions", "Active skin infections in the treated area", "Ongoing significant weight fluctuation", "Unrealistic expectations about scar visibility"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Firmer, smoother, and better-proportioned thighs", "Improved comfort while walking and exercising", "Reduced inner thigh chafing", "Better confidence in fitted clothing and swimwear", "Long-lasting results with stable weight"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Scarring (carefully placed, fades over time)", "Healing time of 2–3 weeks required", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol before surgery", "Inform the doctor about medical conditions or medications", "Maintain a stable body weight", "Follow all pre-surgery instructions provided"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Wear compression garments as advised", "Avoid strenuous physical activity and heavy lifting", "Keep the surgical area clean and dry", "Take prescribed medications as directed", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
