        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "General / Local + Sedation" }, { label: "Initial Recovery", value: "2–3 weeks" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Loose or sagging upper arm skin", "Post weight-loss skin laxity", "Arms with poor tone and contour", "Individuals at a stable body weight", "Good overall health with realistic expectations"].map((item: any, i: number) => (
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Uncontrolled medical conditions", "Active skin infections on upper arms", "Ongoing significant weight fluctuation", "Unrealistic expectations about scar visibility"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Firmer, more toned upper arms", "Improved arm contour and shape", "Enhanced confidence in sleeveless clothing", "Long-lasting results with stable weight", "Often combined with liposuction for best results"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Scarring along the inner arm (fades over time)", "Healing time of a few weeks required", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol before surgery", "Inform the doctor about medical conditions or medications", "Maintain a stable body weight", "Follow all pre-surgery instructions provided during consultation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Wear compression garments as advised", "Avoid heavy lifting and strenuous arm activity", "Keep the surgical area clean and dry", "Take prescribed medications as advised", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
