        ...
        <section>
          ...
          <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ step: "1. Blood Collected", desc: "A small blood sample is drawn — similar to a routine blood test" }, { step: "2. PRP Prepared", desc: "Blood is processed in a medical centrifuge to concentrate platelets and growth factors" }, { step: "3. PRP Applied", desc: "Growth factor-rich PRP is carefully injected into targeted areas to stimulate tissue rejuvenation and nerve response" }].map((item: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Reduced sexual sensitivity or arousal", "Difficulty achieving orgasm", "Vaginal dryness", "Mild urinary stress incontinence", "Post-childbirth or age-related intimate changes", "Desire for natural, non-surgical intimate wellness support"].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Improved sensitivity and arousal", "Enhanced orgasmic response", "Improved vaginal tissue health and hydration", "May help with mild urinary incontinence", "Natural, drug-free treatment using own PRP", "Non-surgical with minimal downtime"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Mild tenderness (temporary)", "Temporary swelling at injection site", "Results vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Inform the doctor about medical conditions or medications", "Maintain proper hydration", "Avoid alcohol before the procedure", "Follow all consultation instructions carefully"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid strenuous physical activity for 24 hours", "Maintain intimate hygiene as advised", "Follow all post-procedure instructions provided", "Attend follow-up visits if recommended"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
