      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {cystTypes.map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Anaesthesia", value: "Local" }, { label: "Procedure Type", value: "Outpatient / Minor" }, { label: "Recovery", value: "Quick, same day" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Growing in size", "Causing pain or discomfort", "Becoming infected or inflamed", "Affecting appearance", "Located in a troublesome area", "Causing anxiety or concern"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Never squeeze or press a cyst at home — this can cause infection", "Active infection may require treatment before surgery", "Cysts should always be evaluated before removal", "Sent for histopathology if clinically indicated"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Complete and clean removal of cyst", "Reduced risk of recurrence", "Quick outpatient procedure", "Minimal scarring with precise technique", "Relief from discomfort and infection risk", "Peace of mind from professional evaluation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Mild soreness or discomfort post-procedure", "Minimal scarring (size-dependent)", "Low risk of recurrence if wall fully removed", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Do not squeeze or press the cyst", "Inform the doctor about medications or medical conditions", "Keep the area clean before the procedure", "Follow all pre-procedure instructions provided"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Keep the treated area clean and dry", "Follow wound care and dressing instructions", "Avoid touching or scratching the area", "Take prescribed medicines as advised", "Attend follow-up visits as recommended"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
