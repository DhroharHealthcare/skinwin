      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {scarTypes.map((item: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Laser scar revision", "Chemical peels", "Microneedling", "PRP / growth factor-based therapies", "Medical topical treatments"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Excision and re-closure of scars", "Scar repositioning", "Advanced suturing techniques", "Z-plasty or W-plasty for complex scars"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Visible or prominent scars", "Acne, injury, or surgical scars", "Old or new scars", "Raised, depressed, or discolored scars", "Scars affecting confidence or appearance"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-red-50/50 rounded-2xl p-8 border border-red-100">
              ...
              <ul className="space-y-3">
                {["Active skin infections in the treated area", "Certain medical conditions (evaluated during consultation)", "Unrealistic expectations of complete scar removal"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Significantly improved scar appearance", "Better skin texture and tone", "Reduced visibility of raised or pitted scars", "Customized approach for each scar type", "Non-surgical options available for many scars", "Boosted confidence and comfort"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary redness or mild swelling", "Skin sensitivity for a short period", "Gradual results — multiple sessions may be needed", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid excessive sun exposure before treatment", "Inform the doctor about medications or medical conditions", "Do not pick or irritate the scar", "Follow all instructions provided during consultation"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Avoid sun exposure and apply sunscreen as advised", "Use prescribed skincare products only", "Avoid touching or scratching the treated area", "Attend follow-up sessions as recommended"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
