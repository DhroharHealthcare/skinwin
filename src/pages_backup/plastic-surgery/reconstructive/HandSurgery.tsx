        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Anaesthesia", value: "Local / Regional" }, { label: "Procedure Type", value: "Outpatient / Day-care" }, { label: "Recovery", value: "Condition-dependent" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Improved hand function and movement", "Pain relief and comfort", "Better quality of daily life", "Treatment of infection or inflammation", "Improved appearance of the hand"].map((item: any, i: number) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary stiffness or swelling", "Healing time varies by condition", "Physiotherapy may be required", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Inform the doctor about medical conditions or medications", "Avoid smoking before surgery", "Follow all pre-procedure instructions carefully", "Arrange for assistance at home if needed post-surgery"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Follow all hand movement restrictions given", "Keep the surgical site clean and dry", "Attend physiotherapy sessions if advised", "Take prescribed medications as directed", "Attend all follow-up visits regularly"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
