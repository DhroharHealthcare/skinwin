        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical" }, { label: "Anaesthesia", value: "General / Local" }, { label: "Initial Recovery", value: "1–2 weeks" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50/50 rounded-2xl p-8 border border-green-100">
              ...
              <ul className="space-y-3">
                {["Enlarged male breast tissue (one or both sides)", "Hormonal or weight-related gynecomastia", "Males embarrassed by chest appearance", "Those not responding to lifestyle changes", "Adults with stable weight and good health"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Underlying hormonal causes should be addressed first", "Stable body weight recommended before surgery", "Non-smokers or those who can quit before surgery", "Realistic expectations about results"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Flat, firm, masculine chest contour", "Permanent results in most cases", "Minimal, well-hidden scarring", "Improved confidence and self-image", "Comfortable in fitted clothing"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling and bruising", "Short recovery period required", "Mild discomfort during healing", "Results may vary from person to person"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Avoid smoking and alcohol", "Inform the doctor about hormonal or medical conditions", "Follow all pre-surgery instructions carefully", "Arrange for someone to accompany on surgery day"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Wear compression garments as advised", "Avoid chest workouts and heavy lifting initially", "Keep the surgical area clean and dry", "Take prescribed medications as advised", "Attend all follow-up appointments"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
