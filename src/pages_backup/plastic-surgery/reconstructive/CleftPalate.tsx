          ...
          <div className="space-y-4">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-2">
                {["Closing the opening in the palate", "Restoring normal palate structure and function", "Improving speech development", "Preventing food and liquid from entering the nasal cavity"].map((item: any, i: number) => (
            ...
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {["Speech therapy after surgery", "Hearing evaluation and care", "Dental and orthodontic treatment", "Psychological support for child and family", "Nutritional guidance for infants", "Follow-up and revision surgery if needed"].map((item: any, i: number) => (
        ...
        <section>
          ...
          <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[{ label: "Procedure Type", value: "Surgical (Palatoplasty)" }, { label: "Anaesthesia", value: "General" }, { label: "Care Type", value: "Long-term / Staged" }].map((stat: any, i: number) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FBF5E9]/50 rounded-2xl p-8 border border-[#C09A50]/20">
              ...
              <ul className="space-y-3">
                {["Improved feeding and swallowing", "Better speech and language development", "Reduced risk of ear infections", "Improved facial function and appearance", "Enhanced quality of life and confidence"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-[#C09A50] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3">
                {["Temporary swelling or discomfort post-surgery", "Healing time required", "Some cases may need additional procedures", "Results may vary depending on severity"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50/50 rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="space-y-3">
                {["Complete pre-operative medical evaluation", "Inform the doctor about all medical history", "Nutritional optimization for infant/child", "Follow all pre-surgery instructions carefully"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
                    <span className="h-2 w-2 bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-gray-700 text-sm">{item}</span>
                  </li>
            ...
            <div className="bg-teal-50/50 rounded-2xl p-8 border border-teal-100">
              ...
              <ul className="space-y-3">
                {["Follow feeding and oral care instructions carefully", "Avoid any pressure or injury to the palate area", "Attend all follow-up visits as scheduled", "Begin speech therapy as advised", "Attend dental and hearing evaluations as recommended"].map((item: any, i: number) => (
                  <li key={i} className="flex items-start">
