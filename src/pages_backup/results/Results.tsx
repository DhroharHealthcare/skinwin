...
const BeforeAfterCard = ({ treatment, resultIndex = 1, openModal }: { treatment: any; resultIndex?: number; openModal: (before: string, after: string) => void }) => {
      ...
      <div className="grid grid-cols-2 relative">
        <div className="relative overflow-hidden">
          <img
            ...
            onError={(e) => { (e.target as HTMLImageElement).src = `https://placehold.co/400x300/f3f4f6/9ca3af?text=Before`; }}
          />
        ...
        <div className="relative overflow-hidden">
          <img
            ...
            className="w-full h-52 object-cover group-hover:scale-105 transition-transform duration-500"
            onClick={() => openModal(beforeImage, afterImage)}
            onError={(e) => { (e.target as HTMLImageElement).src = `https://placehold.co/400x300/f3f4f6/9ca3af?text=After`; }}
          />
...
const CategorySection = ({ categoryData, isVisible, openModal }: { categoryData: any; isVisible: boolean; openModal: (before: string, after: string) => void }) => {
  if (!isVisible) return null;
  return (
    <div className="mb-20">
      {categoryData.treatments.map((treatment: any, i: number) => (
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        {/* Results */}
        {selectedCategory === "All"
          ? Object.entries(resultsData).map(([key, data]: [string, any]) => (
              <div key={key}>
